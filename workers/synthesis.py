...
def _call_llm(messages: list) -> str:
    ...
    """
    client = OpenAIGenerator(model_name="gpt-4o-mini", temperature=0.1, max_tokens=500)
    response = client.generate(query=messages, system_prompt=SYSTEM_PROMPT)
    return response
